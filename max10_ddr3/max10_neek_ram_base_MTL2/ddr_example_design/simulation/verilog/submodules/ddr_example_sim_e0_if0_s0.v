...
`timescale 1 ps / 1 ps
module ddr_example_sim_e0_if0_s0 (
	...
	rw_manager_ddr3 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("MAX10"),
		.AC_ROM_INIT_FILE_NAME                ("ddr_example_sim_e0_if0_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("ddr_example_sim_e0_if0_s0_inst_ROM.hex"),
	...
	ddr_example_sim_e0_if0_s0_mm_interconnect_0 mm_interconnect_0 (
