...
# Board skews
set board(abs_max_CK_delay) 0.314
set board(abs_max_DQS_delay) 0.199
set board(minCK_DQS_skew) 0.115
set board(maxCK_DQS_skew) 0.142
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.007
set board(inter_DQS_group_skew) 0.0267
set board(DQ_DQS_skew) -3.0E-4
set board(intra_addr_ctrl_skew) 0.0116
set board(addresscmd_CK_skew) -0.005
