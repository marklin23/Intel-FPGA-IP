...
`timescale 1 ps / 1 ps
module pio_test_mm_interconnect_0 (
	...
	wire  [101:0] sysid_qsys_0_control_slave_agent_rp_data;                           // sysid_qsys_0_control_slave_agent:rp_data -> router_001:sink_data
	...
	pio_test_mm_interconnect_0_router router (
	...
	pio_test_mm_interconnect_0_router_001 router_001 (
	...
	pio_test_mm_interconnect_0_router_001 router_002 (
	...
	pio_test_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //        clk.clk
		.reset              (sysid_qsys_0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	pio_test_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_test_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_test_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_test_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_test_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_test_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
