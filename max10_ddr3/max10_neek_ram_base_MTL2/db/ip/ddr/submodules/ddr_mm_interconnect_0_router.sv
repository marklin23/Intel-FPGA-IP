...
module ddr_mm_interconnect_0_router_default_decode
  #(
...
module ddr_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD3 = log2ceil(64'h8000040 - 64'h8000020); 
    localparam PAD4 = log2ceil(64'h8208000 - 64'h8200000); 
    // -------------------------------------------------------
    ...
    ddr_mm_interconnect_0_router_default_decode the_default_decode(
